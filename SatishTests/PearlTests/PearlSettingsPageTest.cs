...
namespace Tests
{
   ...
   // [TestFixture("Edge")]
    ...
    public class PearlSettingsPage : SetupTearDown
    {

        public PearlSettingsPage(string b)
        {
        ...
        [Category("Smoke")]
        [Test]
        public void Pearl_Settings_Page()
        {
            ...
            Assert.IsTrue(Pages.PearlSettingsPage.SettingsPage(), "Error while performing actions in Settings Page");
