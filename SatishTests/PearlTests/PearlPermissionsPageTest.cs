...
namespace Tests
{
   ...
   // [TestFixture("Edge")]
    ...
    public class PearlPermissionsPage : SetupTearDown
    {

        public PearlPermissionsPage(string b)
        {
        ...
        [Category("Smoke")]
        [Test]
        public void Pearl_Permissions_Page()
        {
            ...
            Assert.IsTrue(Pages.PearlPermissionsPage.PermissionsPage(), "Error while performing actions in Permissions Page");
