...
namespace Tests
{
   ...
   // [TestFixture("Edge")]
    ...
    public class HierarchyRolloverLists : SetupTearDown
    {

        public HierarchyRolloverLists(string b)
        {
        ...
        [Category("Smoke")]
        [Test]
        public void Hierarchy_Rollover_List_and_Unit()
        {
            ...
            Assert.IsTrue(Pages.PearlHierarchyPage.RolloverListUnit(), "Unable to Rollover list/unit.");
