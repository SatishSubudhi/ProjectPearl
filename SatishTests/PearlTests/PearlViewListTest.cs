...
namespace Tests
{
   ...
   // [TestFixture("Edge")]
    ...
    public class PearlViewList : SetupTearDown
    {

        public PearlViewList(string b)
        {
        ...
        public void Pearl_View_List()
        {
            ...
            //Pages.PearlViewList.GoTo();
            Assert.IsTrue(Pages.PearlViewList.ViewList(), "Error while Verifying View List Page");
            //Logs User Out
