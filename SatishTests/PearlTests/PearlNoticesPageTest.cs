...
namespace Tests
{
   ...
   // [TestFixture("Edge")]
    ...
    public class PearlNoticesPage : SetupTearDown
    {

        public PearlNoticesPage(string b)
        {
        ...
        [Category("Smoke")]
        [Test]
        public void Pearl_Notices_Page()
        {
            ...
            Assert.IsTrue(Pages.PearlNoticesPage.NoticesPage(), "Error while performing actions in Notices Page");
