...
namespace Tests
{
   ...
   // [TestFixture("Edge")]
    ...
    public class HierarchySuppressLists : SetupTearDown
    {

        public HierarchySuppressLists(string b)
        {
        ...
        [Category("Smoke")]
        [Test]
        public void Hierarchy_Suppress_List_and_Unit()
        {
            ...
            Assert.IsTrue(Pages.PearlHierarchyPage.SuppressUnsuppress(), "Unable to Suppress/Unsuppress list/unit.");
